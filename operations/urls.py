...
path('admin-panel/',views.admin_dashboard,name='admin_dashboard'),path('admin-panel/reports/',views.admin_reports,name='admin_reports'),path('admin-panel/visits/',views.admin_visits,name='admin_visits'),path('admin-panel/users/add/',views.create_user,name='create_user'),path('admin-panel/import/',views.csv_import,name='csv_import'),path('admin-panel/services/',views.service_catalog,name='service_catalog'),
